...
func Test_slo_DefaultAPIService(t *testing.T) {
	...
	t.Run("Test DefaultAPIService V1ReportGet", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.DefaultAPI.V1ReportGet(context.Background()).Execute()
	...
	t.Run("Test DefaultAPIService V1ReportIdDelete", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var id string

		httpRes, err := apiClient.DefaultAPI.V1ReportIdDelete(context.Background(), id).Execute()
	...
	t.Run("Test DefaultAPIService V1ReportIdGet", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var id string

		resp, httpRes, err := apiClient.DefaultAPI.V1ReportIdGet(context.Background(), id).Execute()
	...
	t.Run("Test DefaultAPIService V1ReportIdPut", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var id string

		httpRes, err := apiClient.DefaultAPI.V1ReportIdPut(context.Background(), id).Execute()
	...
	t.Run("Test DefaultAPIService V1ReportPost", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.DefaultAPI.V1ReportPost(context.Background()).Execute()
